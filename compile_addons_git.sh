...
<h2 id="missing-your-addon">Is your add-on missing from the list?</h2>
<p>Simply edit the description of your repository and add the new topic "grass-gis-addons". It will then appear here after the next run of the relevant scripts.</p>
